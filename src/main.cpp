...
CBigNum bnProofOfWorkLimit(~uint256(0) >> 8);
CBigNum bnProofOfStakeLimit(~uint256(0) >> 8);
...
unsigned int nModifierInterval = 10 * 30;
...
const string strMessageMagic = "quid Signed Message:\n";
...
// quid: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "quid", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "sQUIDward, July 2014 - The Only Currency you'll ever need!";
        CTransaction txNew;
        txNew.nTime = 1406493614;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1406493614;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1375149;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3a1b1120e5013ea3b12ce8be4c91ea8a77b21886efc9d4fcf36750e1de6ead1f"));
        block.print();
